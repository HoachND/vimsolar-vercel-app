    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm min-h-[300px]">
          <h3 className="text-lg font-bold text-gray-900 mb-4 border-b border-gray-100 pb-3">Hoạt động gần đây</h3>
          <div className="flex flex-col gap-4">
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 mt-2 rounded-full bg-blue-500"></div>
              <div>
                <p className="text-sm font-medium text-gray-900">Hợp đồng HĐ-2026-001 đã được ký</p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Chờ xác nhận khảo sát dự án SunPro 5kWp</p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Hoàn tất thanh toán đợt 1 hợp đồng HĐ-2026-003</p>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm min-h-[300px]">
          <h3 className="text-lg font-bold text-gray-900 mb-4 border-b border-gray-100 pb-3">Tiến độ thi công</h3>
          <div className="space-y-4">
            <div>
              <div className="flex justify-between text-sm mb-1">
                <span className="font-medium">Dự án Nguyễn Văn A - 10kWp</span>
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                <span className="font-medium">Dự án Trần Thị B - 5kWp</span>
